package it.prova.springkafkaconsumer;
...
public class SpringKafkaConsumerApplication {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ConfigurableApplicationContext context = SpringApplication.run(SpringKafkaConsumerApplication.class, args);
    ...
    //Classi statiche MessageProducer e MessageListener
